...
public class StringExample2 {
	...
	public static void main(String[] args) {
       ...
       {
        	System.out.println("var6 variable value is NOT EQUAL to var5 variable value");
        ...
        System.out.println("_________Finding the number of character of a String___________");
        System.out.println();
        
        int Priya=var10.length();
        System.out.println("The number of characters in the variable var10 is :-"+Priya);
        
        System.out.println();
        
        System.out.println("____finding which variable is greater than var1 and var2 ______Not related to alphabet greatness - but for the number of characters of the string___________________________________");
        ...
        System.out.println("___________________OR- Finding the greater string value__________________________");
        System.out.println();
        ...
        String var11="Sai Madhu Chandu";
        
        System.out.println("The character at the index 1 is :-"+var11.charAt(0 ));
        
        System.out.println("The character at the index 6 is  :-"+var11.charAt(4));
