...
public class TSRTC_DisplayLinksNames {
		...
		*/
		...
		List<WebElement>tsrtcApplicationHomePageLinks=driver.findElements(linksProperty);
		 ...
		 int tsrtcApplicationHomePageLinks_Count=tsrtcApplicationHomePageLinks.size();
		     ...
		     {
		    	String  tsrtcApplicationHomePage_LinkName =tsrtcApplicationHomePageLinks.get(arrayindex).getText();
		    	
		    	System.out.println(arrayindex+"  -  "+tsrtcApplicationHomePage_LinkName);
		     }
