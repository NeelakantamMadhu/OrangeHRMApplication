...
public class TSRTC_Comparing_URl {
			 ...
			 */
			            ...
			            WebElement  TSRTCHomePageHeaderLinks=driver.findElement(LinksProperty1);
			                 ...
			                 for(int arrayindex=0;  arrayindex<TSRTCHomePageHeaderLinks_Count;  arrayindex++) 
			                 {
			                	...
			                	String expectedUrl=TSRTCHomePageHeaderLink.get(arrayindex).getAttribute("href");
			                	System.out.println(expectedUrl);
			                	 ...
			                	 if (actual_webPageUrlAddress.equals(expectedUrl)) 
			                	 {
